...
export const StatCard = ({ title, description, primaryValue, secondaryValue, icon: Icon, percent }: StatCardProps) => {
    return (
            ...
            <Card className="rounded-xs p-3 gap-y-3 w-full overflow-hidden">
                ...
                <CardContent className="p-0">
                    <div className="flex items-baseline">
                        <NumberTicker startValue={0} value={primaryValue} direction="up" className="text-2xl font-semibold" />
