...
import { RoomSchema, RoomSchemaType } from "@workspace/utils/schema"
...
export const EditRoomFormView = ({ id }: EditHouseFormViewProps) => {
    ...
    const { mutate: updateRoom, isPending } = useMutation(
        trpc.room.updateOne.mutationOptions({
            ...
            onSuccess: async (data) => {
                ...
                await Promise.all([
                    queryClient.invalidateQueries(trpc.room.getMany.queryOptions({ ...filters })),
