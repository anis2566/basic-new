...
export const DeleteTeacherModal = () => {
    ...
    const { isOpen, teacherId, onClose } = useDeleteTeacher();
    const trpc = useTRPC()
    ...
    const { mutate: deleteTeacher } = useMutation(
        trpc.teacher.deleteOne.mutationOptions({
            onError: (err) => {
    ...
    return (
        <AlertDialog open={isOpen && !!teacherId} onOpenChange={onClose}>
            <AlertDialogContent className="rounded-xs">
                <AlertDialogHeader>
                    <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
                    <AlertDialogDescription>
                        This action cannot be undone. This will permanently delete your teacher
