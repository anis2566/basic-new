...
const RateDetailsStep = ({ form, trigger, isPending, editStates, toggleEdit, isCreating }: RateDetailsStepProps) => (
    <div className="grid md:grid-cols-2 gap-6 items-start">
        <EditableField
            form={form}
            name="classRate"
...
export const TeacherFormView = () => {
    ...
    const { mutate: createTeacher, isPending } = useMutation(trpc.teacher.createOne.mutationOptions({
        onError: (err) => {
    ...
    const renderStepContent = useMemo(() => {
        ...
        switch (currentStep) {
            ...
            case 6:
                return <RateDetailsStep {...stepProps} editStates={editStates} toggleEdit={toggleEdit} isCreating={isPending} />;
            default:
                return null;
        }
                ...
                <div className="flex items-center justify-between mt-6">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button
                            ...
                            disabled={isPending}
                        >
                            {currentStep === STEPS.length && !isPending ? "Register Teacher" : "Next"}
