...
const filterParmas = {
    ...
    className: parseAsString.withDefault("").withOptions({ clearOnDefault: true }),
    id: parseAsString.withDefault("").withOptions({ clearOnDefault: true }),
    transactionId: parseAsString.withDefault("").withOptions({ clearOnDefault: true }),
...
export const getPayments = createLoader(filterParmas);