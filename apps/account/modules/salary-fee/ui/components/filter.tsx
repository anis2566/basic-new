...
import { DEFAULT_PAGE, DEFAULT_PAGE_SIZE, DEFAULT_PAGE_SIZE_OPTIONS, DEFAULT_SORT_OPTIONS, GROUP } from "@workspace/utils/constant"
...
export const Filter = () => {
    const [filter, setFilter] = useGetFees()
        ...
        <div className="flex-1 flex items-center justify-between gap-x-3">
            <div className="flex-1 flex items-center gap-2">
                ...
                <FilterSelect
                    ...
                    placeholder="Group"
                    options={Object.values(GROUP).map(v => ({ label: v, value: v }))}
