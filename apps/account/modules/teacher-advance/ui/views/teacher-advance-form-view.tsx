...
export const TeacherAdvanceFormView = () => {
    ...
    const { data, isLoading: isLoadingTeachers } = useQuery(trpc.teacher.forSelect.queryOptions({ name: searchTeacher, id: searchTeacherId }))
