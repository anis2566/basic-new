...
import { DEFAULT_PAGE, DEFAULT_PAGE_SIZE, DEFAULT_PAGE_SIZE_OPTIONS, DEFAULT_SORT_OPTIONS, Months, Sessions } from "@workspace/utils/constant";
            ...
            <DrawerContent className="p-4">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <FilterSelect
                        ...
                        placeholder="Month"
                        options={Object.values(Months).map(v => ({ label: v, value: v }))}
                        className="max-w-full"
                        showInMobile
                    />
                    <FilterSelect
