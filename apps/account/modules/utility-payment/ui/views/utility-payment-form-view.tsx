...
import { UtilityPaymentSchema, UtilityPaymentSchemaType } from "@workspace/utils/schema"
...
export const UtilityPaymentFormView = () => {
    ...
    const { mutate: createPayment, isPending } = useMutation(
        trpc.utilityPayment.createOne.mutationOptions({
            ...
            onSuccess: async (data) => {
                ...
                queryClient.invalidateQueries(trpc.utilityPayment.getMany.queryOptions({ ...filters }))
