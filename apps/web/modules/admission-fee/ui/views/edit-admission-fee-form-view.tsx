...
export const EditAdmissionFeeFormView = ({ id }: EditFeeFormViewProps) => {
    ...
    const { data } = useSuspenseQuery(trpc.admissionFee.getOne.queryOptions(id))
        ...
        trpc.admissionFee.updateOne.mutationOptions({
            ...
            onSuccess: async (data) => {
                ...
                await Promise.all([
                    ...
                    queryClient.invalidateQueries(trpc.admissionFee.getOne.queryOptions(id))
                ]);
